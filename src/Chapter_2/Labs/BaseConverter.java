...
public class BaseConverter {
    ...
    public static void main (String[] args) {
        ...
        int base10Num; //the number in base10
        ...
        System.out.print ("Please enter a base 10 number lower than " + maxNumber + " to convert: ");
        ...
        System.out.println(baseBNum + place3 + place2 + place1 + place0);
    }
}
